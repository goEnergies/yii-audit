...
class Bootstrap implements BootstrapInterface
{
    ...
    public function bootstrap($app)
    {
        ...
        \Yii::setAlias('@goenergies/yii2/audit', __DIR__);

        if ($app instanceof \yii\console\Application) {
            $app->controllerMap['audit'] = 'goenergies\yii2\audit\commands\AuditController';
        }
        ...
        if ($app->has('i18n')) {
            $app->i18n->translations['audit'] = [
                ...
                'sourceLanguage' => 'en',
                'basePath'       => '@goenergies/yii2/audit/messages',
            ];
        }
    }
}
