...
namespace goenergies\yii2\audit\models;

use goenergies\yii2\audit\Audit;
use goenergies\yii2\audit\components\db\ActiveRecord;
use goenergies\yii2\audit\components\Helper;
use Yii;
...
/**
 * AuditEntry
 * @package goenergies\yii2\audit\models
 *
 * @property int               $id
