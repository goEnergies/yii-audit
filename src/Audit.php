 ...
 * audit process.
 *
 * @author    Steve Guns <steve@goenergies.com>
 * @package   com.goenergies.yii2.audit
 * @copyright 2014-2015 B&E DeZign
 */

namespace goenergies\yii2\audit;
 ...
 *     'modules' => [
 *        'audit' => 'goenergies\yii2\audit\Audit',
 *     ]
 *   or optionally with configuration:
 *     'modules' => [
 *        'audit' => [
 *            'class' => 'goenergies\yii2\audit\Audit',
 *            'ignoreActions' => ['debug/*']
 *     ]
 * - If you want to auto track actions, be sure to add the module to the application bootstrapping:
 *    'bootstrap' => ['audit'],
 *
 * @package goenergies\yii2\audit
 * @property AuditEntry $entry
 *
 * @method void data($type, $data)                                                                      @see ExtraDataPanel::trackData()
 * @method \goenergies\yii2\audit\models\AuditError exception(\Exception $exception)                      @see ErrorPanel::log()
 * @method \goenergies\yii2\audit\models\AuditError errorMessage($message, $code, $file, $line, $trace)   @see ErrorPanel::logMessage()
 */
class Audit extends Module
{
    ...
    private $_corePanels = [
        ...
        'audit/request'    => ['class' => 'goenergies\yii2\audit\panels\RequestPanel'],
        'audit/db'         => ['class' => 'goenergies\yii2\audit\panels\DbPanel'],
        'audit/log'        => ['class' => 'goenergies\yii2\audit\panels\LogPanel'],
        'audit/asset'      => ['class' => 'goenergies\yii2\audit\panels\AssetPanel'],
        'audit/config'     => ['class' => 'goenergies\yii2\audit\panels\ConfigPanel'],
        'audit/profiling'  => ['class' => 'goenergies\yii2\audit\panels\ProfilingPanel'],

        // Special other panels
        'audit/error'      => ['class' => 'goenergies\yii2\audit\panels\ErrorPanel'],
        'audit/javascript' => ['class' => 'goenergies\yii2\audit\panels\JavascriptPanel'],
        'audit/trail'      => ['class' => 'goenergies\yii2\audit\panels\TrailPanel'],
        'audit/mail'       => ['class' => 'goenergies\yii2\audit\panels\MailPanel'],
        'audit/extra'      => ['class' => 'goenergies\yii2\audit\panels\ExtraDataPanel'],
        'audit/curl'       => ['class' => 'goenergies\yii2\audit\panels\CurlPanel'],
        'audit/soap'       => ['class' => 'goenergies\yii2\audit\panels\SoapPanel'],
    ];
    ...
    /**
     * @var \goenergies\yii2\audit\models\AuditEntry If activated this is the active entry
     */
    private $_entry = null;
