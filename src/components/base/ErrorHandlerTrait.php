...
namespace goenergies\yii2\audit\components\base;

use goenergies\yii2\audit\Audit;
use goenergies\yii2\audit\models\AuditError;
use goenergies\yii2\audit\panels\ErrorPanel;
use Exception;
use Yii;

/**
 * ErrorHandlerTrait
 * @package goenergies\yii2\audit\components\base
 */
